...
import { ArrowLeft, Globe, Mail, Lock, LogIn } from "lucide-react";
...
const Login = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      toast({
        title: "Welcome to Erthaloka DAO!",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-emerald-50 flex items-center justify-center p-4">
      ...
      <Card className="w-full max-w-md bg-white/80 backdrop-blur-sm border-green-100 eco-shadow relative z-10">
        <CardHeader className="text-center space-y-4">
          ...
          <CardDescription>
            Sign in to your Erthaloka DAO account and continue your regenerative journey
          </CardDescription>
        </CardHeader>
